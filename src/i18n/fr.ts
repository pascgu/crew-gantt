...
export const fr = {
  ...
  columns: {
    ...
    searchTask: 'Chercher…',
    choose: 'Afficher/masquer des colonnes',
    show: 'Afficher',
    hide: 'Masquer',
  ...
  help: {
    ...
    planning: {
      ...
      s4Body: "1. Donnez l’Effort (j-h, référence libre — souvent l’estim).\n2. Posez le début en ajoutant un bloc.\n3. Affectez — la barre se cale sur le Reste.\n4. Chaque semaine, mettez à jour le Reste dans le panneau.\n5. Le bord droit tire la fin et ajuste le Reste en temps réel.",
      s5Title: '5. Les deux gestes — bord gauche et bord droit',
      s5Body: "Bord droit (tâche effort) : tire la fin → ajuste le reste à faire. Bord gauche (tâche effort) : déplace le début et ajuste le reste pour garder la fin fixe. La partie sombre de la barre = reste à faire (après le trait de réunion). Bords (tâche dates fixées) : déplacent simplement les dates.",
    },
    legend: {
      ...
      progressDrag: "Glisser l'encoche noire (tâche dates fixées) — régler l'avancement",
