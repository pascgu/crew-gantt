...
export const fr = {
  ...
  help: {
    ...
    concepts: {
      ...
      linksBody:
        "Un lien borne le début au plus tôt d'une tâche : démarrer après est permis, seul démarrer avant est un conflit. Jamais un aimant qui déplace tout seul.\n\nL'infobulle donne un code compact : F = fin, D = début (P = après N jours travaillés) + un décalage en jours ouvrés sans le zéro. Ex. : FD = fin → début ; P1D3 = après 1 j travaillé → début +3 j. Un délai positif sur un point « après N jours » est précédé d'un « + » pour lever l'ambiguïté : P2+1D = après 2 j travaillés, +1 j de délai.\n\nPendant la création d'un lien, maintenir SHIFT permet d'ancrer « après N jours » sur le prédécesseur (au départ) ou sur le successeur (à l'arrivée).",
